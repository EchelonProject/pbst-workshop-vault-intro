...
1. Navigate to https://bit.ly/3tDFJVK
<br>Alternate link: https://play.instruqt.com/hashicorp/invite/9gcgnwudh2kw
1. Click "Add to my Study Room"
1. Click "My Exclusives"

There should be three (3) tracks added:
* PBST Vault Basics
* PBST Vault Dynamic Database Credentials
* PBST Vault Encryption as a Service
